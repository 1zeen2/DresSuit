...
function DressDetail(){
    ...
    const {isLoading,isError,error,data} = useQuery(['dress-detail',no],
        async ()=>{
            return await apiClient.get(`/dress/detail/${no}`)
        }
    )
    if(isLoading)
    ...
    // 쿠키 저장 => 기간 options
    setCookie("dress_"+no,data.data.image)
    return (
        <Fragment>
                            ...
                            <div className="row no-gutters">
                                <div className="col-12 col-sm-12">
                                    ...
                                    <table className="table">
                                        ...
                                        <tr>
                                            <td>
                                                <img src={data.data.d_image} alt="Dress Image Error"
                                                     style={{width: '800px', height: 'auto'}}/>
                                                <img src={data.data.d_image2}
                                                     style={{width: '800px', height: 'auto'}}/>
                                                <img src={data.data.d_image3}
                                                     style={{width: '800px', height: 'auto'}}/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    <MapLocation address={data.data.address} name={'라비토로사'}/>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table className="table">
                                        ...
                                        <tr>
                                            <td className="text-center">
                                                <Link to="/dress/list" className="btn btn-xs btn-outline-info">목록</Link>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
